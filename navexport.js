...
let navbar001=()=>{
    ...
    <div id="top_navbar">
        <div id="header"
            style="background-color: green; color: white; font-size: 20px; padding: 5px; text-align: center;  position: fixed; top: 0px; left: 0px; right: 0px;">
    ...
    <div id="navbar" >
        <div class="wrapper" style="background-color: rgb(233, 232, 232);padding: 5px 120px; display: flex; align-items: center;  position: fixed; top: 30px; left: 0px; right: 0px; height: 50px;">
            ...
            <div id="a1">
                <div class="right-menu">
                    ...
                    <div class="dropdown-menu">
                        <a href="./All Fruits.html">ALL FRUITS</a>
                        <a href="./Fresh Cuts.html">FRESH CUTS</a>
                        <a href="./Combo.html">FRUIT COMBOS</a>
                        <a href="./Gift.html">GIFTS BY KIMAYE</a>
                        <a href="./Graps.html">GRAPE FAMILY BY KIMAYE</a>
                ...
                <div class="right-menu">
                    ...
                    <div class="dropdown-menu">
                        <a href="https://kimaye.com/pages/our-story">OUR STORY</a>
                        <a href="https://kimaye.com/pages/why-kimaye">WHY KIMAYE</a>
                        <a href="https://kimaye.com/pages/traceability">TRACEABILITY</a>
                        <a href="https://kimaye.com/pages/beyond-fruits">BEYOND FRUITS</a>
                    </div>
                </div>

                <div class="right-menu">
                    <a href="./Grow.html">  <button class="menu-button">GROW </button></a>
            ...
            <div id="a3">
                <div style="display: flex; align-items: center;" class="right-menu">
                 ...
                 <div id="cart-icon" class="carticon">
                    <a href="./cart.html"><img style="margin-left: 10px; width: 30px;" src="https://static.thenounproject.com/png/1100446-200.png" alt=""></a>
